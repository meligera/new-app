...
<html lang="en-US" class="no-js">
	<head>
		...
		<!-- ==============================================
		JS I DONT KNOW HOW IT WORKS GOD HELP ME!
		=============================================== -->
	...
	<body data-spy="scroll" data-target="#main-nav" data-offset="400">
		...
		<div id="main-nav" class="navbar navbar-fixed-top">
			<div class="container">
				...
				<div class="navbar-header">
					...
					<!-- ======= LOGO ========-->
					<a class="navbar-brand scrollto" href="#home"><img src="assets/images/logo2.png" alt="" /></a>
				...
				<div id="site-nav" class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						<li>
							<a href="https://www.youtube.com/channel/UCapwgTbhgYD1cfvLVJhAHsA" class="scrollto"><i class="fa fa-youtube-play" aria-hidden="true"></i></i>Мой канал</a>
						</li>
						<li>
							<a href="#about" class="scrollto"><i class="fa fa-graduation-cap"></i>Обо мне</a>
						</li>
						<li>
							<a href="#portfolio" class="scrollto"><i class="fa fa-briefcase"></i>Мои работы</a>
						</li>
						<li>
							<a href="#contact" class="scrollto"><i class="fa fa-envelope"></i>Контакты</a>
						</li>
					</ul>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-sm-10 col-sm-offset-1 text-center">
						...
						<h1 class="scrollimation fade-down d1">Елизавета Купцова</h1>
						<h2 class="scrollimation fade-down d3"><span class="main-color">А</span>ктриса, <span class="main-color">М</span>узыкант, <span class="main-color">М</span>ечтатель</h2>
				...
				<div class="header-img scrollimation fade-up d1">
					<img class="img-responsive" src="assets/images/liza-test.png" alt="" />
				</div>
		...
		<div id="main-content">
			...
			<div class="scroll-down">
				<a href="#services" class="scrollto">Узнать больше</a>
			</div>
			...
			<section id="about" class="big-padding">
				...
				<div class="container">
					...
					<h1 class="section-title">Обо мне<span class="main-color">1</span></h1>
					...
					<div class="row profile">
						...
						<div class="col-sm-10 col-sm-offset-1 text-center">
							...
							<figure class="hover-wrapper scrollimation fade-right">
								<img class="img-responsive img-circle profile-img" src="assets/images/liza-img.jpg" alt="">
								<figcaption class="hover-text">Это Я!</figcaption>
							</figure>
							
							<h2 class="scrollimation fade-left">Елизавета Купцова</h2>
							<h3 class="scrollimation fade-left">Музыкант</h3>
						
							<p class="margin-top scrollimation fade-right">Меня зовут Лиза, мне 19 лет и я выпускница Гнесинской академии. Я обожаю создавать что-то новое своими руками. Я сшила не одну сотню игрушек и хотела бы поделится секретами мастерства со всеми!</p>
							
							<p class="lead margin-top scrollimation fade-left">Создание что-то нового для меня не просто работа, это моя страсть. </p>
							<p class="scrollimation fade-left"><a class="btn btn-dc btn-main-color scrollto" href="#portfolio">Мои работы</a></p>
			...
			<section id="portfolio" class="big-padding" >
				...
				<div class="container">
					...
					<h1 class="section-title">Мои работы<span class="main-color">2</span></h1>
					<p class="subtitle">Все это может сшить любой желающий!</p>
					
					<!--==== Portfolio Filters ====-->
					
					<div class="text-center scrollimation fade-up">
						<div id="filter-works" class="btn-group">
							<button data-filter="*" type="button" class="btn btn-default active">Все работы<span class="project-count"></span></button>
							<button data-filter=".web" type="button" class="btn btn-default">Новый Год<span class="project-count"></span></button>
							<button data-filter=".print" type="button" class="btn btn-default">Подарки<span class="project-count"></span></button>
							<button data-filter=".video" type="button" class="btn btn-default">Украшения<span class="project-count"></span></button>
						</div>
					</div>
				...
				<div class="container scrollimation fade-up">
					...
					<p class="lead text-center">Вам понравилось? Подпишитесь на мой канал!</p>
					<p class="text-center"><a class="btn btn-dc btn-main-color scrollto" href="https://www.youtube.com/channel/UCapwgTbhgYD1cfvLVJhAHsA">Подписаться</a></p>
				...
				<div class="container text-center scrollimation fade-right">
					...
					<div class="row">
						...
						<div class="col-sm-10 col-sm-offset-1">
							...
							<p><i class="fa fa-youtube-play fa-4x" aria-hidden="true"></i></p>
							
							<div id="twitter-slider" class="flexslider" data-widget-id="386017398488186880" data-max-tweets="5"></div>
					
							<p><a href="https://www.youtube.com/channel/UCapwgTbhgYD1cfvLVJhAHsA" data-toggle="tooltip" data-placement="bottom" title="Не забудьте подписаться!" target="_blank">@eliza_makes</a></p>
			...
			<section id="contact" class="big-padding light-typo color-overlay">
				...
				<div class="container">
					...
					<h1 class="section-title">Контакты<span class="main-color">3</span></h1>
					
					<div class="row">
					
						<div class="col-sm-6 col-md-5 scrollimation fade-right">
						
							<p class="lead">Я всегда рада Вам ответить! <br/>Готова услышить любые предложения.</p>
						
							<p>
								Купцова Лиза<br/>
								Blumenstrauß 192-1<br/>
								France, Nice 892-722<br/>
								(999) 777 - 1468 <br/>
							</p>
							...
							<p><a class="mail-styled" href="mailto:mail@example.com">eliza-makes@google.com</a></p>
						...
						<form id="contact-form" class="col-sm-6 col-md-offset-1 scrollimation fade-left" action="contact.php" method="post" novalidate>
							...
							<div class="form-group">
								<div class="controls">
									...
									<label class="control-label" for="contact-mail">Почта</label>
								</div>
							</div><!-- End email input -->
					...
					<div class="row">
						...
						<div class="col-sm-2">
							...
							<a class="logo-link scrollto" href="#home">
								<img class="img-responsive" src="assets/images/logo-bw2.png" alt="" />
							</a>
						...
						<div class="col-sm-8">
							...
							<nav>
								...
								<ul class="footer-nav">
									...
									<li><a class="scrollto" href="https://www.youtube.com/channel/UCapwgTbhgYD1cfvLVJhAHsA">Мой канал</a></li>
									<li><a class="scrollto" href="#portfolio">Обо мне</a></li>
